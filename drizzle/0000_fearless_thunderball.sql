...
CREATE TYPE "public"."BusinessSize" AS ENUM('SIZE_1_10', 'SIZE_11_50', 'SIZE_51_200', 'SIZE_201_PLUS');--> statement-breakpoint
...
CREATE TYPE "public"."FeedbackCategory" AS ENUM('BUG', 'IMPROVEMENT', 'THANKS', 'OTHER');--> statement-breakpoint
CREATE TYPE "public"."FeedbackStatus" AS ENUM('OPEN', 'REVIEWED', 'RESOLVED');--> statement-breakpoint
...
CREATE TABLE "Business" (
	...
	"aboutBusiness" varchar(2000),
	"missionText" varchar(1000),
	CONSTRAINT "Business_ownerId_name_key" UNIQUE("ownerId","name")
);
--> statement-breakpoint
...
ALTER TABLE "JobPosting" ADD CONSTRAINT "JobPosting_businessId_Business_id_fk" FOREIGN KEY ("businessId") REFERENCES "public"."Business"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "Business_ownerId_idx" ON "Business" USING btree ("ownerId");--> statement-breakpoint
...
CREATE INDEX "JobPosting_businessId_idx" ON "JobPosting" USING btree ("businessId");--> statement-breakpoint
...
CREATE UNIQUE INDEX "Conversation_seekerId_employerId_coldDm_key" ON "Conversation" USING btree ("seekerId","employerId") WHERE "jobId" is null;--> statement-breakpoint
...
CREATE INDEX "Feedback_userId_createdAt_idx" ON "Feedback" USING btree ("userId","createdAt");