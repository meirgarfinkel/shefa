  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        align={align}
        className={cn(
          "bg-dark text-muted-foreground z-50 max-h-(--radix-dropdown-menu-content-available-height) min-w-32 overflow-auto rounded-md p-1 shadow-md",
          className,
        )}
        {...props}
      />
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        ...
        "data-open:bg-primary data-open:text-dark",
        inset && "pl-7",
        className,
      )}
      {...props}
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn("bg-popover z-50 min-w-32 overflow-auto rounded-md p-1 shadow-md", className)}
      {...props}
    />
  );
}
